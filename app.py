...
def update_employee_leave(userName: str,leave_start_date: str,leaave_end_date: str,leave_type: str):
    result = cpa_sql.update_employee_leave(userName,leave_start_date,leaave_end_date,leave_type)
